...
r"""Classic example : OCC Bottle"""

import math

from OCC.gp import gp_Pnt, gp_OX, gp_Vec, gp_Trsf, gp_DZ, gp_Ax2, gp_Ax3, \
...
from OCC.Geom import Geom_Plane, Geom_CylindricalSurface, Handle_Geom_Plane, \
    Handle_Geom_Surface
from OCC.Geom2d import Geom2d_Ellipse, Geom2d_TrimmedCurve, \
    Handle_Geom2d_Ellipse, Handle_Geom2d_Curve
