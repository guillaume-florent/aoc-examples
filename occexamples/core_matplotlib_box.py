...
r"""Small example how to use the Tesselator interface to draw a shape with matplotlib

Notes
-----
Modifications to Tesselator.cpp made mid december 2015 -> needs a rebuild of pythonocc-core
