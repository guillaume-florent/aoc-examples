...
from occaddons.kbe.base import Display
...
pl1 = make_closed_polygon(gp_Pnt(-10, -10, 0), gp_Pnt(10, -10, 0), gp_Pnt(10, 10, 0), gp_Pnt(-10, 10, 0),)

pl2 = make_closed_polygon(gp_Pnt(0, -10, -10), gp_Pnt(0, 10, -10), gp_Pnt(0, 10, 10), gp_Pnt(0, -10, 10),)
