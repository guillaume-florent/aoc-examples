...
from occaddons.paf.parametric import Parameters
from occaddons.paf.context import ParametricModelingContext
...
# ===============================================================================
ShapeType = {"COMPOUND": 0, "COMPSOLID": 1, "SOLID": 2, "SHELL": 3, "FACE": 4, "WIRE": 5, "EDGE": 6, "VERTEX": 7,
             "SHAPE": 8}
...
# ===============================================================================
# SO WE GOT 2 VALID GROUPS, BUT NONE CAN BE ADDED TO "aMesh" !!!
# ===============================================================================
...
# write it to a file that can be solve with Code_Aster
# aMesh.ExportMED("/Users/localadmin/Documents/workspace/pyocc/src/examples/Level2/FEM/_TEST.med")
