...
r"""An example illustrating how to update components in an XDE document and have the View
...
from OCC import XCAFApp, TDocStd, TCollection, XCAFDoc, BRepPrimAPI, Quantity, TopLoc, gp, TPrsStd, XCAFPrs, AIS
