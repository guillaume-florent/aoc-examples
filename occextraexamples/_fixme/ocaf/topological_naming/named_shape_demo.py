...
from OCC import BRepPrimAPI, TNaming, TDocStd, AppStd, TCollection, TDF, AIS
...
# Need to build a map covering all the OCAF nodes which might contain relevant shapes
