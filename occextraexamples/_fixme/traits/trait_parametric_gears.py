...
r"""A sample that shows how to generate the gear geometry according
to knowledge
"""
...
from occaddons.paf.parametric import Parameters, Rule, Relation, symb
from math import pi
...
p.H1 = 20.0  # height
p.Angle1 = 0.0
gear1 = my_context.prim_operations.MakeCylinderPntVecRH(my_pnt1, my_vec1, p.R1, p.H1, p.Angle1, name="Gear1",
                                                        show=True)
