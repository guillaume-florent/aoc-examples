...
from occutils.construct import make_closed_polygon, make_n_sided, make_vertex, make_face, make_wire
from occaddons.dataexchange.iges import IgesImporter
...
def build_plate(polygon, points):
    ...
    return make_face(plate.Surface(), u_min, u_max, v_min, v_max)
